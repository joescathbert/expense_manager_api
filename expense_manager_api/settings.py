"""
Django settings for expense_manager_api project.
...
SECRET_KEY = 'django-insecure-6tp8(699y$@(pb5nfv&(d(bk$d%$-=93fqqaeid$@p1pls+*np'
...
ROOT_URLCONF = 'expense_manager_api.urls'
...
WSGI_APPLICATION = 'expense_manager_api.wsgi.application'
